<div class="content-wrapper">
        ...
        <section class="invoice" id="tsprint">
          ...
          <div class="row no-print">
            <div class="col-xs-12">
              <form action="<?=base_url('cart/act_upload')?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="exampleInputFile">Upload Foto atau Bukti</label>
                    <input type="hidden" name="id" value="<?= $invoice[0]->id ?>">
                    <input type="file" id="exampleInputFile" name="fileku" required="">
                    <p class="help-block">File GIF, JPG dan PNG</p>
                </div>
                <button type="submit" class="btn btn-success pull-right"><i class="fa fa-credit-card"></i> Upload Bukti</a>
              </form>
            </div>
          </div>
        </section>
