                      ...
                      echo $data->stok;
                        ...
                        <input type="hidden" name="idbarang" value="<?=$data->id?>">
                            <div class="form-group">
                                ...
                                <input id="id_set_val_satuan" class="form-control" name="jml" type="number" required="" autofocus="" placeholder="Masukkan Jumlah Satuan" value="1">
                            </div>
                            <button class="btn btn-block btn-primary btn-sm" type="submit">Tambah</button>
                        </form>
                        <a href="<?= base_url() ?>" class="btn btn-block btn-default btn-sm" style="margin-top: 10px; margin-bottom: 10px;">Kembali</a>
                        </div>
